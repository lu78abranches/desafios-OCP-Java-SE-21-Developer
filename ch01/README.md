...
Usando import explícito
Usando o fully qualified name (sem import)
Usando wildcard import
...
Sem parâmetros — define brand = "Unknown", year = 0
Recebe brand — delega para o construtor sem parâmetros e depois sobrescreve brand
Recebe brand e year
...
Implemente Greeter como local class (classe dentro do método)
Implemente Greeter como anonymous class (new Greeter() { ... })
